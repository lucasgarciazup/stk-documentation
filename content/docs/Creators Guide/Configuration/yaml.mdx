...
3. Comandos a serem executados pelo comando [**`stk deploy`**]({{< ref path="/stk-deploy.md" >}}) do CLI.
...
- Para **template.yaml**: Os valores válidos são **env-template** e **app-template**, indicando se o Template pode ser usado no [<ins>**`stk create env`**</ins>]({{< ref path="/docs/References/Commands List/stk-create-env.md" >}}), [<ins>**`stk create app`**</ins>]({{< ref path="/docs/References/Commands List/stk-create-app.md" >}}) ou nos dois.
