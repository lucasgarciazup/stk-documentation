...
- [<ins>**Verifique se o STK CLI está atualizado**</ins>]({{< ref path="/stk-upgrade.md" >}})
...
Na pasta **`templates`**, você deve criar o código fonte do Template. Exemplo: Um Template HTML pode ser composto por um arquivo **`index.html`**. Veja mais sobre Templates na seção [**Criar um template**]({{< ref path="/howto-create-template.md" >}}).  
...
> Para definir e encontrar os **`inputs`** e os **`computed-inputs`**, acesse a [**seção de Arquivos.yaml**]({{< ref path="/yaml.md" >}})
...
Depois que o [<ins>**stackfile**</ins>]({{< ref path="/docs/References/Commands List/stk-create-stackfile.md" >}}) foi criado, é possível definir o tipo dele e predefinir um input. 
...
- Adicione uma Stack ao seu projeto com [<ins>**`stk import stack`**</ins>]({{< ref path="/docs/References/Commands List/stk-import-stack.md" >}}).
- Liste as Stacks disponíveis com [<ins>**`stk list stack`**</ins>]({{< ref path="/docs/References/Commands List/stk-list-stack.md" >}}).
- Atualize todas as Stacks disponíveis com [<ins>**`stk update stack`**</ins>]({{< ref path="/docs/References/Commands List/stk-update-stack.md" >}}).  
