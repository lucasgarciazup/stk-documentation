...
Este tutorial vai mostrar a segunda opção. Para mais detalhes da primeira forma, consulte a página [<ins>**`Criar uma Stack`**</ins>]({{< ref path="/docs/Creators Guide/howto-create-stack.md" >}})
...
Para mais detalhes, veja a seção da [documentação sobre a **estrutura do `template.yaml`**]({{< ref path="/docs/Creators Guide/Configuration/yaml.md" >}}).
